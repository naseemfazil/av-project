...
const RewardsRecognition = () => {
    ...
    const rewardsRecognition = [
...

        {
            ...
            content: "Recognize outstanding achievements and present an award to someone deserving !",
            btnTxt: "Give Award",
            bgImg: GiveBadges
        },

        {
            ...
            content: "Reward achievements and distribute badges to acknowledge excellence !",
            btnTxt: "Give Badges",
            bgImg: GiveGift
        },

        {
            ...
            content: "Make someone's day brighter with a thoughtful gift. Show your appreciation !",
            btnTxt: "Give Gift",
            bgImg: GiveGreeting
        },
